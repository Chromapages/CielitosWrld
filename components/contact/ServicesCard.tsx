    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-xl font-bold text-stone-800">
            <LocalizedText k="contact.services.title" />
          </h3>
        </div>
      ...
      >
        <div className="overflow-hidden md:overflow-visible space-y-2">
          <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-orange-50 transition-colors duration-200 group/service">
            ...
            <span className="text-sm text-stone-700 group-hover/service:text-orange-700 transition-colors duration-200">
              <LocalizedText k="contact.services.portrait" />
            </span>
          </div>
          <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-orange-50 transition-colors duration-200 group/service">
            <div className="w-2 h-2 bg-orange-500 rounded-full flex-shrink-0 group-hover/service:scale-125 transition-transform duration-200"></div>
            <span className="text-sm text-stone-700 group-hover/service:text-orange-700 transition-colors duration-200">
              <LocalizedText k="contact.services.event" />
            </span>
          </div>
          <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-orange-50 transition-colors duration-200 group/service">
            <div className="w-2 h-2 bg-orange-500 rounded-full flex-shrink-0 group-hover/service:scale-125 transition-transform duration-200"></div>
            <span className="text-sm text-stone-700 group-hover/service:text-orange-700 transition-colors duration-200">
              <LocalizedText k="contact.services.commercial" />
            </span>
          </div>
          <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-orange-50 transition-colors duration-200 group/service">
            <div className="w-2 h-2 bg-orange-500 rounded-full flex-shrink-0 group-hover/service:scale-125 transition-transform duration-200"></div>
            <span className="text-sm text-stone-700 group-hover/service:text-orange-700 transition-colors duration-200">
              <LocalizedText k="contact.services.collab" />
            </span>
          </div>
          <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-orange-50 transition-colors duration-200 group/service">
            <div className="w-2 h-2 bg-orange-500 rounded-full flex-shrink-0 group-hover/service:scale-125 transition-transform duration-200"></div>
            <span className="text-sm text-stone-700 group-hover/service:text-orange-700 transition-colors duration-200">
              <LocalizedText k="contact.services.editing" />
            </span>
          </div>
        </div>
      </div>
