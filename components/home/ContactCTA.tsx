        ...
        <div className="bg-[#1a1e14] p-6 rounded-lg border border-white/10 shadow-xl">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span className="text-sm text-white">{data?.email || 'Abajo.Del.Cieloo@gmail.com'}</span>
          ...
          <div className="mt-6">
            <Link
              href={buttonLink}
              className="btn-press block w-full text-center bg-[#822c01] hover:bg-[#9d3501] text-white font-fitzgerald-bold py-3 px-6 rounded-md transition-all duration-300 shadow-[0_4px_14px_0_rgba(130,44,1,0.39)]"
            >
              {buttonText}
            </Link>
