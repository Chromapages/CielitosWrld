        ...
        <section className="-mt-16 pb-24 relative z-20 px-4">
            <div className="container mx-auto max-w-[1400px]">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    ...
                    {packages.length < 4 && (
                        <div className="flex flex-col p-8 rounded-3xl border border-brand-200 dark:border-brand-800 bg-brand-50 dark:bg-brand-950/50 flex items-center justify-center text-center">
