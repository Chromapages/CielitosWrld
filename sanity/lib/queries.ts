...
export const HOME_PAGE_QUERY = `
  {
    "hero": *[_type == "homePage"][0].hero {
      ...
      backgroundPosterImage { asset->{ _id, url, metadata { dimensions, lqip } } },
      mobileBackgroundPosterImage { asset->{ _id, url, metadata { dimensions, lqip } } },
      "backgroundVideoUrl": backgroundVideo.asset->url,
      "mobileBackgroundVideoUrl": mobileBackgroundVideo.asset->url,
      backgroundMediaAlt,
      ctaText,
      ctaLink,
      secondaryCtaText,
